...
TRAEFIK_WEBUI_BASIC_AUTH=${TRAEFIK_WEBUI_BASIC_AUTH:-""}
TRAEFIK_WEBUI_DIGEST_AUTH=${TRAEFIK_WEBUI_DIGEST_AUTH:-""}
...
TRAEFIK_WEBUI_AUTH=""
if [ "X${TRAEFIK_WEBUI_BASIC_AUTH}" != "X" ]; then
    TRAEFIK_WEBUI_AUTH="\
[web.auth.basic]
users = [\"${TRAEFIK_WEBUI_BASIC_AUTH}\"]
"
fi
